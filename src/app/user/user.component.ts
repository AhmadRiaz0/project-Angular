...
import { output } from '@angular/core'; //Fonction output(), permet de déclarer une sortie depuis les composants enfants vers les composants parents.
...
export class UserComponent {
 ...
 //@Output() select = new EventEmitter(); //Objet EventEmitter, envoyer des événements d'un composant enfant vers un composant parent. 
  select = output<string>();  //Déclare un output avec le type de paramètre attendue. Stocke implicitement un objet EventEmitter, donc fonctionne de la même manière
